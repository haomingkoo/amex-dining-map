...
const ZOOM_CONFIG = {
  ...
  MARKER_TARGET_LEVEL: 14,         // Default zoom level when clicking marker (street-level detail)
  ...
  CONTINENT_ZOOM: 15,              // Zoom for very far out (continent/world view)
  COUNTRY_ZOOM: 14.5,              // Zoom for country/region view
