...
const ZOOM_CONFIG = {
  ...
  MARKER_TARGET_LEVEL: 12,         // Default zoom level when clicking marker (mild zoom)
  ...
  CONTINENT_ZOOM: 13,              // Zoom for very far out (continent/world view)
  COUNTRY_ZOOM: 12.5,              // Zoom for country/region view
