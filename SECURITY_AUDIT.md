...
| Medium | Movable action tags, unrestricted Actions, no security updates | Pinned every action to an immutable commit, restricted the repository to GitHub-owned SHA-pinned actions, enabled dependency security updates, and added weekly pip/Actions Dependabot checks. |
